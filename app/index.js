...
app.post('/api/init', function(req, res){
	...
	global.processes[http_default] = spawn("qemu-system-x86_64", ["-hda","win2k.disk","-vnc","127.0.0.1:" + port], {stdio: "inherit"});
});
...
function reboot(){
fetch(location.href + 'api/reboot', {
    method: 'POST',
	  headers: {
        'Content-Type': 'application/json'
    },
